/* <NavLink
          ...
          <NavLink
            ...
            alt="/#"
            style={{
              color: pathname.includes("dialogs/0") ? "red" : "grey",
              fontWeight: pathname.includes("dialogs/0") ? "700" : "300",
              fontSize: pathname.includes("dialogs/0") ? "32px" : "22px",
            }}
            className={classes.sidebar__items}
          >
            sasha
...
// witch (action.type) {=================================================with immer  i dont know
//   case follow:
//     return produce(state, draftState => {
//       draftState.users = draftState.users.map(u => {
//         if (u.id === action.userId) {
//           u.followed = false;
//         }
//         return u;
...
{
  /* <Content TextArea={props.TextArea} /> */
}
//  state={props.state}
...
//  );
// User
// вот именно такойкод и был и он выдавал ошибку import { useDispatch } from "react-redux";
...
// import React from "react";===============================================================login form issue solving in git this is a not working version
